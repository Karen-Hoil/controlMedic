...
function Cuadro() {
  ...
  const [isMorningAccordionOpen, setIsMorningAccordionOpen] = useState(false);
  const [isMediodiaAccordionOpen, setIsMediodiaAccordionOpen] = useState(false);
  const [isTardeAccordeionOpen, setIsTardeAccordionOpen] = useState(false);
  const [isNocheAccordionOpen, setIsNocheAccordionOpen] = useState(false);
  const [isCualquieraAccordionOpen, setIsCualquiraAccordionOpen] = useState(false);
  ...
  return (
    <>
      ...
      >
        <h1 style={{ marginBottom: 20, color:'rgba(81, 192, 185, 1)', textAlign:'center', fontSize:50, fontWeight:'bold', fontFamily:'inherit'}}>CONTROL DE MEDICAMENTOS</h1>
        <p>Nota: se debe de recargar paa que aparezca la medicina</p>
        <div
          style={{
            marginTop: 50,
            marginLeft: 50,
          ...
          {medicina.map((medicamento) => (
            ...
            >
              ...
              tardeMedicamento.some(
                ...
                <button onClick={() => agregarMedicamento(medicamento)} style={{backgroundColor:'rgba(81, 192, 185, 1)', height:40, paddingLeft:5, paddingBottom:5, borderColor:'#00000000', borderRadius:5}}>
      ...
      <AccordionItem>
                  ...
                  onClick={() => setIsMorningAccordionOpen(!isMorningAccordionOpen)}>
                    <svg
        ...
        >
          {/* Información del medicamento para el mediodía */}
          {morningMedicamento &&
            Array.isArray(morningMedicamento) &&
            morningMedicamento.map((medicamento, index) => {
    ...
    <AccordionItem>
                  ...
                  onClick={() => setIsMediodiaAccordionOpen(!isMediodiaAccordionOpen)}>
                    <svg
                  ...
                  {isMediodiaAccordionOpen && (
        <div
          style={{
            position: "absolute",
            top: "100%",
            left: 100,
            backgroundColor: "rgba(255, 255, 202)",
            padding: "10px",
            borderRadius: "5px",
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          {mediodiaMedicamento &&
            ...
            mediodiaMedicamento.map((medicamento, index) => {
              const horaDelMedicamento = new Date(
    ...
    <AccordionItem>
                  ...
                  onClick={() => setIsTardeAccordionOpen(!isTardeAccordeionOpen)}>
                    <svg
        ...
        >
          {/* Información del medicamento para el tarde*/}
          {tardeMedicamento &&
            Array.isArray(tardeMedicamento) &&
            tardeMedicamento.map((medicamento, index) => {
              const horaDelMedicamento = new Date(
    ...
    <AccordionItem>
                  ...
                  onClick={() => setIsNocheAccordionOpen(!isNocheAccordionOpen)}>
                    <svg
                      style={{ marginLeft: 40, marginTop: 15 }}
                      viewBox="0 0 48 48"
                      height="100px"
        ...
        >
          ...
          {nocheMedicamento &&
            ...
            nocheMedicamento.map((medicamento, index) => {
              const horaDelMedicamento = new Date(
    ...
    <AccordionItem>
                  ...
                  onClick={() => setIsCualquiraAccordionOpen(!isCualquieraAccordionOpen)}>
                    <svg
        ...
        >
          ...
          {cualquieraMedicamento &&
            ...
            cualquieraMedicamento.map((medicamento, index) => {
              const horaDelMedicamento = new Date(
                `2000-01-01T${medicamento.horamediodia}`
              );
              const horaActual = new Date();
