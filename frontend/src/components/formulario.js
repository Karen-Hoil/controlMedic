    ...
    <>
      ...
      <div style={{ marginTop: 130, marginLeft: 50, marginRight: 50 }}>
        ...
        <form onSubmit={agregarMedicamento}>
          ...
          <button type="submit" style={{backgroundColor:'rgba(81, 192, 185, 1)', height:40, paddingLeft:5, paddingBottom:5, borderColor:'#00000000', borderRadius:5, marginBottom:30}}>Agregar Medicamento</button>
        </form>
      </div>
    </>
  );
